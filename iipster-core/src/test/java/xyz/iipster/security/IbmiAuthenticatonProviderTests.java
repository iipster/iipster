...
//        final IbmiAuthenticationProvider iap = new IbmiAuthenticationProvider(as400);
//
...
//        final IbmiAuthenticationProvider iap = new IbmiAuthenticationProvider(as400);
//
//        assertThat(iap.authenticate(new UsernamePasswordAuthenticationToken("nouser", "password")))
//                .isNull();
//    }
//
//    @Test
